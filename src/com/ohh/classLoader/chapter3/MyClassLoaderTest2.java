...
public class MyClassLoaderTest2 {
    public static void main(String[] args) throws ClassNotFoundException {
        ...
        // 父委托机制
        final Class<?> aClass = myClassLoader2.loadClass("com.ohh.classLoader.chapter3.MyObject");
        ...
        final Class<?> aClass3 = myClassLoader3.loadClass("com.ohh.classLoader.chapter3.MyObject");
