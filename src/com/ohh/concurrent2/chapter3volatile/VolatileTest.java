 ...
 * volatile 关键字 - 可见性
 * <p>
 * 在多线程环境中，线程的安全问题往往通过保证操作的原子性解决，
 * 比如通过使用 synchronized 关键字，使线程的操作串行化，进而
 * 保证了多个组合操作的原子性，但是除了原子性，还有一个不可忽视
 * 的问题，那就是可见性，什么是可见性，比如多个线程共享了同一个
 * 变量 value，如果一个线程修改了 value 那么其他线程是否会及时的
